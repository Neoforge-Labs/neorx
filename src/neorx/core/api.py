...
async def run_pipeline_endpoint(request: RunRequest) -> StatusResponse:
    ...
    """
    from neorx.core.pipeline import run_pipeline
...
async def screen_target_endpoint(request: ScreenTargetRequest) -> dict[str, Any]:
    ...
    from neorx.core.pipeline import _generate_for_target, _screen_candidates
    from neorx.core.scoring.scorer import rank_candidates
