...
def screen_generated(
    ...
    *,
    ...
    Integrates with the ``neorx.molscreen`` pipeline to assess
    ...
    try:
        ...
        from neorx.molscreen.filters import run_all_filters, classify_drug_likeness
        from neorx.molscreen.accessibility import sa_score, qed_score
    except ImportError:
        logger.warning(
