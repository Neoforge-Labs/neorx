...
Usage examples::
    ...
    python -m neorx.dockbot prepare-protein 1BNA --output-dir ./docking

    # Detect binding site from co-crystallised ligand
    python -m neorx.dockbot binding-site ./docking/1BNA_clean.pdb --method ligand

    # Dock a single ligand
    python -m neorx.dockbot dock 1BNA "CC(=O)Oc1ccccc1C(O)=O" --name aspirin

    # Screen a library
    python -m neorx.dockbot screen 1BNA library.csv --output-dir results
"""
