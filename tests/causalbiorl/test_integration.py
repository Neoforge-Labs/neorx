...
class TestDiseaseGraphEncoder:
    ...
    def test_extract_node_features(self) -> None:
        from neorx.causalbiorl.causal.graph_encoder import extract_node_features
    ...
    def test_build_edge_tensors(self) -> None:
        from neorx.causalbiorl.causal.graph_encoder import build_edge_tensors
    ...
    def test_disease_graph_to_networkx(self) -> None:
        ...
        from neorx.core.graph.models import DiseaseGraph, GraphNode, GraphEdge, NodeType, EdgeType
...
class TestAdaptiveRewardLearner:
    ...
    def test_compute_reward(self) -> None:
        from neorx.causalbiorl.causal.reward_learner import AdaptiveRewardLearner, OBJECTIVE_NAMES
...
class TestCounterfactualBridge:
    ...
    def test_validate_with_biorl_scm_exists(self) -> None:
        from neorx.core.causal.counterfactual import CounterfactualValidator
